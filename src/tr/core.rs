...
/// For SIMD delete/squeeze on 10MB data, single-core takes ~8-11ms while
/// parallel (4 threads) takes ~2-3ms plus ~0.15ms rayon overhead. The parallel
/// speedup (3-4×) far outweighs the rayon cost for data >= 4MB.
