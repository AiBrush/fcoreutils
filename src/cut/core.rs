...
/// directly into the source data (e.g. mmap). Uses memchr2_iter single-pass
/// SIMD scanning — a single pass finds both delimiters and newlines.
///
...
///
/// Flushes in MAX_IOV-sized batches to respect writev limits.
#[inline]
