...
gcd64:
    ...
    bsf     rcx, rax                    ; rcx = ctz(a)
    bsf     r8, rdx                     ; r8  = ctz(b)
    cmp     ecx, r8d
    cmova   ecx, r8d                    ; ecx = min shift (common 2s)
    push    rcx                          ; save common shift count
    ...
    ; Now both a (rax) and b (rdx) are odd
.g_loop:
    ...
    xchg    rax, rdx
.g_no_swap:
    sub     rax, rdx                     ; a = a - b (even since both odd)
    jz      .g_done                      ; if a == 0, gcd = b << shift

    ; Remove factors of 2 from a (a is now even)
    bsf     rcx, rax
    shr     rax, cl
    jmp     .g_loop
...
.g_done:
    mov     rax, rdx
    pop     rcx                          ; restore common shift count
    shl     rax, cl                      ; restore common factor of 2
    ret
