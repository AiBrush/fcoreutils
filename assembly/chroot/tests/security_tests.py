...
fchroot is a GNU-compatible 'chroot' written in x86-64 Linux assembly.
...
TIMEOUT = 10
TOOL_NAME = "chroot"
BIN = str(Path(__file__).resolve().parent.parent / "fchroot")
GNU = "/usr/bin/chroot"
...
def find_binary():
    ...
    for name in ["fchroot_release", "fchroot"]:
