...
help_text:
    ...
    db "Full documentation <https://www.gnu.org/software/coreutils/base64>", 10
    db "or available locally via: info '(coreutils) base64 invocation'", 10
help_text_len equ $ - help_text

version_text:
    db "base64 (GNU coreutils) 9.7", 10
...
err_extra_operand:
    db "base64: extra operand ", 0xE2, 0x80, 0x98
