...
fpinky is a GNU-compatible 'pinky' written in x86-64 Linux assembly.
lightweight finger information lookup.
"""
...
TIMEOUT = 10
TOOL_NAME = "pinky"
BIN = str(Path(__file__).resolve().parent.parent / "fpinky")
GNU = "/usr/bin/pinky"
...
def find_binary():
    ...
    for name in ["fpinky_release", "fpinky"]:
