; ============================================================
; funexpand_unified.asm — GNU-compatible 'unexpand' command
; Single nasm -f bin file with hand-crafted ELF header.
;
; Converts spaces to tabs with SSE2 SIMD acceleration.
; Supports -a/--all, --first-only, -t/--tabs=N, -t/--tabs=LIST,
; --help, --version, --, multiple files, - for stdin.
; mmap + madvise for regular files, streaming for pipes.
;
; BUILD:
;   nasm -f bin funexpand_unified.asm -o funexpand && chmod +x funexpand
; ============================================================
