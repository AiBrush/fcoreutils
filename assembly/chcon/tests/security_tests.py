#!/usr/bin/env python3
"""security_tests.py — Security & memory safety tests for fchcon (assembly chcon).

fchcon is a GNU-compatible 'chcon' written in x86-64 Linux assembly.
...
TIMEOUT = 10
TOOL_NAME = "chcon"
BIN = str(Path(__file__).resolve().parent.parent / "fchcon")
GNU = "/usr/bin/chcon"
...
def find_binary():
    ...
    for name in ["fchcon_release", "fchcon"]:
