...
str_help:
    ...
    db "Print or check MD5 (128-bit) checksums.", 10
    db 10
    ...
    db "Full documentation <https://www.gnu.org/software/coreutils/md5sum>", 10
    db "or available locally via: info '(coreutils) md5sum invocation'", 10
str_help_len equ $ - str_help

str_version:
    db "md5sum (GNU coreutils) 9.7", 10
