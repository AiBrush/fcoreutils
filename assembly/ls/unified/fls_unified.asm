...
; Source files: tools/fls.asm, lib/io.asm, lib/str.asm
;
; Build: nasm -f bin unified/fls_unified.asm -o fls_release && chmod +x fls_release
;
...
str_try_help:   db "Try 'ls --help' for more information.", 10
