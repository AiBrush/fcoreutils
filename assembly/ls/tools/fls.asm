; fls.asm — GNU-compatible "ls" in x86_64 Linux assembly
;
; Supports: -l, -a, -A, -1, -R, -r, -S, -t, -h, -d, -i, -s, -C,
;           --color=auto/always/never, --help, --version, --, multiple args
;
; Default: one-per-line (stdout not a tty) or multi-column (-C, stdout is tty)
; -l: long format with permissions, links, owner, group, size, date, name
; -a: show all (including . and ..)
; -A: show almost all (excluding . and ..)
;
; Build (modular):
;   nasm -f elf64 -I ./ tools/fls.asm -o build/fls.o
;   nasm -f elf64 -I ./ lib/io.asm -o build/io.o
;   nasm -f elf64 -I ./ lib/str.asm -o build/str.o
;   ld --gc-sections -z noexecstack build/fls.o build/io.o build/str.o -o fls
