...
fptx is a GNU-compatible 'ptx' written in x86-64 Linux assembly.
produce a permuted index.
"""
...
TIMEOUT = 10
TOOL_NAME = "ptx"
BIN = str(Path(__file__).resolve().parent.parent / "fptx")
GNU = "/usr/bin/ptx"
