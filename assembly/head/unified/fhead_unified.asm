...
help_text:
    ...
    db "Full documentation <https://www.gnu.org/software/coreutils/head>", 10
    db "or available locally via: info '(coreutils) head invocation'", 10
help_text_len equ $ - help_text

version_text:
    db "head (GNU coreutils) 9.7", 10
