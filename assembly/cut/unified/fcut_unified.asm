...
help_text:
    ...
    db 10
    db "Use one, and only one of -b, -c or -f.  Each LIST is made up of one", 10
    db "range, or many ranges separated by commas.  Selected input is written", 10
    db "in the same order that it is read, and is written exactly once.", 10
    db "Each range is one of:", 10
    db 10
    db "  N     N'th byte, character or field, counted from 1", 10
    db "  N-    from N'th byte, character or field, to end of line", 10
    db "  N-M   from N'th to M'th (included) byte, character or field", 10
    db "  -M    from first to M'th (included) byte, character or field", 10
    db 10
    db "GNU coreutils online help: <https://www.gnu.org/software/coreutils/>", 10
    db "Full documentation <https://www.gnu.org/software/coreutils/cut>", 10
    db "or available locally via: info '(coreutils) cut invocation'", 10
help_text_len       equ $ - help_text

version_text:
    db "cut (GNU coreutils) 9.7", 10
    ...
    db 10
    db "Written by David M. Ihnat, David MacKenzie, and Jim Meyering.", 10
