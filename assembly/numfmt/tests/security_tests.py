...
fnumfmt is a GNU-compatible 'numfmt' written in x86-64 Linux assembly.
convert numbers from/to human-readable.
"""
...
TIMEOUT = 10
TOOL_NAME = "numfmt"
BIN = str(Path(__file__).resolve().parent.parent / "fnumfmt")
GNU = "/usr/bin/numfmt"
...
def find_binary():
    ...
    for name in ["fnumfmt_release", "fnumfmt"]:
