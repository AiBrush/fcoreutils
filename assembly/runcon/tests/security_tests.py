#!/usr/bin/env python3
"""security_tests.py — Security & memory safety tests for fruncon (assembly runcon).

fruncon is a GNU-compatible 'runcon' written in x86-64 Linux assembly.
run command with specified SELinux context.
"""
...
TIMEOUT = 10
TOOL_NAME = "runcon"
BIN = str(Path(__file__).resolve().parent.parent / "fruncon")
GNU = "/usr/bin/runcon"
...
def find_binary():
    ...
    for name in ["fruncon_release", "fruncon"]:
