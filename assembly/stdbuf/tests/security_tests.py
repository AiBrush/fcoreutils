#!/usr/bin/env python3
"""security_tests.py — Security & memory safety tests for fstdbuf (assembly stdbuf).

fstdbuf is a GNU-compatible 'stdbuf' written in x86-64 Linux assembly.
...
TIMEOUT = 10
TOOL_NAME = "stdbuf"
BIN = str(Path(__file__).resolve().parent.parent / "fstdbuf")
GNU = "/usr/bin/stdbuf"
...
def find_binary():
    ...
    for name in ["fstdbuf_release", "fstdbuf"]:
