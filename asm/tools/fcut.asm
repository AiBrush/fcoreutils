; fcut.asm — GNU-compatible "cut" in x86-64 Linux assembly
;
; A drop-in replacement for GNU coreutils `cut`. Pure x86-64 assembly,
; no libc, no dynamic linker. Handles all flags: -b, -c, -f, -d, -s,
; -z, -n, --complement, --output-delimiter, --help, --version, --.
;
; BUILD:
;   cd asm && make fcut
...
%define RANGE_SHIFT     4               ; log2(16) — each range is 16 bytes
...
delim:              resb 1
line_delim:         resb 1
only_delimited:     resb 1
complement:         resb 1
zero_terminated:    resb 1
past_dashdash:      resb 1
had_error:          resb 1
has_open_end:       resb 1
out_delim_set:      resb 1
tmp_char:           resb 1
                    resb 5          ; padding to 16

range_spec:         resq 1
num_ranges:         resd 1
                    resd 1
ranges:             resb MAX_RANGES * 16

num_files:          resd 1
current_fd:         resd 1
current_filename:   resq 1
files:              resq MAX_FILES

out_delim_len:      resd 1
out_delim_buf:      resb MAX_OUTDELIM

alignb 16
bitset:             resb BITSET_SIZE
